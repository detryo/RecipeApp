...
class DataSet {
    ...
    let breakfast = [ Recipe(title: "Slow cooker breakfast beans", imageName: "Slow cooker breakfast beans", ingridients: "1 tbsp olive oil. \n4 1 onion thinly sliced. \n4 2 garlic cloves. chopped, \n4 1 tbsp white or red wine vinegar. \n4 1 heaped tbsp soft brown sugar. \n4 400g can pinto beans, drained and rinsed. \n4 200ml passata. \n4 small bunch coriander, chopped ", instructions: "Heat the slow cooker if necessary. Heat the oil in a large frying pan and fry the onion until it starts to brown, then add the garlic and cook for 1 min. Add the vinegar and sugar and bubble for a minute. Stir in the beans and passata and season with black pepper. Tip everything into the slow cooker.", preparation: "5 HRS", timeToCook: "30 MINS", difficulty: "EASY", serves: "SERVES 4")]
